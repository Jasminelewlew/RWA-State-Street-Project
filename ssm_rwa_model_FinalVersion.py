...
# This is an assumption, not a real number
# I picked $24.5M specifically
...
def rwa_for_row(exposure, collateral, haircut, risk_weight,
    ...
    I believe this is the core idea behind "capital
    optimization": it's about how well-collateralized a book is, not how
    big it is.
    """
    if equity_sensitive:
...
print("=== Baseline ===")
print(f"Total RWA: ${base_rwa:.1f}M")
print(f"CET1 Ratio: {cet1_ratio(CET1_CAPITAL, base_rwa):.1%}")
for cat, val in base_by_cat.items():
    print(f"  {cat}: ${val:.1f}M")
...
print(f"Total RWA: ${stress_rwa:.1f}M")
print(f"Stressed CET1 Capital: ${stress_capital:.1f}M")
print(f"Stressed CET1 Ratio: {cet1_ratio(stress_capital, stress_rwa):.1%}")
...
print(f"Business Indicator, 2023 draft (gross services leg): ${bi_2023:.1f}M")
print(f"Business Indicator, 2026 re-proposal (net services leg): ${bi_2026:.1f}M")
print(f"Operational Risk RWA, 2023 draft: ${op_rwa_2023:.1f}M")
print(f"Operational Risk RWA, 2026 re-proposal: ${op_rwa_2026:.1f}M")
print(f"New CVA RWA - baseline: ${cva_base:.1f}M | stressed: ${cva_stress:.1f}M")
...
print(f"{'Scenario':<38}{'RWA ($M)':>12}{'CET1 Ratio':>14}")
print(f"{'Current Basel III - Baseline':<38}{rwa_current_base:>12.1f}{cet1_ratio(CET1_CAPITAL, rwa_current_base):>14.1%}")
print(f"{'Current Basel III - Stressed':<38}{rwa_current_stress:>12.1f}{cet1_ratio(stress_capital, rwa_current_stress):>14.1%}")
print(f"{'Endgame 2023 draft - Baseline':<38}{rwa_eg23_base:>12.1f}{cet1_ratio(CET1_CAPITAL, rwa_eg23_base):>14.1%}")
print(f"{'Endgame 2023 draft - Stressed':<38}{rwa_eg23_stress:>12.1f}{cet1_ratio(stress_capital, rwa_eg23_stress):>14.1%}")
print(f"{'Endgame 2026 re-proposal - Baseline':<38}{rwa_eg26_base:>12.1f}{cet1_ratio(CET1_CAPITAL, rwa_eg26_base):>14.1%}")
print(f"{'Endgame 2026 re-proposal - Stressed':<38}{rwa_eg26_stress:>12.1f}{cet1_ratio(stress_capital, rwa_eg26_stress):>14.1%}")
